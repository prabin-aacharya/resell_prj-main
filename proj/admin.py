...
class BikeResellAdminSite(AdminSite):
    ...
    def get_urls(self):
        ...
        custom_urls = [
            ...
            path('products/add/', self.admin_view(admin_views.ProductCreateView.as_view()), name='admin_product_add'),
            path('products/<int:pk>/edit/', self.admin_view(admin_views.ProductUpdateView.as_view()), name='admin_product_edit'),
            path('products/<int:pk>/delete/', self.admin_view(admin_views.ProductDeleteView.as_view()), name='admin_product_delete'),
            path('products/<int:pk>/detail/', self.admin_view(admin_views.ProductDetailView.as_view()), name='admin_product_detail'),
            path('customers/', self.admin_view(admin_views.CustomerListView.as_view()), name='admin_customer_list'),
            path('customers/add/', self.admin_view(admin_views.CustomerCreateView.as_view()), name='admin_customer_add'),
            path('customers/<int:pk>/detail/', self.admin_view(admin_views.CustomerDetailView.as_view()), name='admin_customer_detail'),
            path('customers/<int:pk>/edit/', self.admin_view(admin_views.CustomerUpdateView.as_view()), name='admin_customer_edit'),
            ...
            path('sellers/add/', self.admin_view(admin_views.SellerInfoCreateView.as_view()), name='admin_seller_add'),
            path('sellers/<int:pk>/edit/', self.admin_view(admin_views.SellerInfoUpdateView.as_view()), name='admin_seller_edit'),
            path('sellers/<int:pk>/delete/', self.admin_view(admin_views.SellerInfoDeleteView.as_view()), name='admin_seller_delete'),
            path('bike-purchases/', self.admin_view(self.bike_purchases_view), name='admin_bike_purchases'),
            ...
            path('sales-report/', self.admin_view(generate_pdf_sales_report_admin), name='admin_sales_report'),
        ]
    ...
    def login(self, request, extra_context=None):
        ...
        """
        # staff user ley login garyo bhaney dasbord ma janey
        if request.user.is_authenticated and request.user.is_staff:
            return redirect('admin:index')
        # show login form valid user navaye
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not selected_product and form.cleaned_data.get('bike_model'):
            ...
            product = Product(
                ...
                made_year=made_year or datetime.datetime.now().year,  
